  ...
  return (
    ...
    <div>
      ...
      <h1 className="container d-flex justify-content-center mt-5">
        Mi Primera Lista de Tareas <i className="icono fa-solid fa-list mt-1"></i>
      </h1>
      ...
      <div className="container d-flex justify-content-center mt-5">
        <div className="notebook shadow">
          ...
          <input
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter" && tarea.trim() !== "") { /* Comprueba que la tecla sea Enter y evita que almacene nada cuando el input está vacío */
                setNuevaTarea([...nuevaTarea, tarea,]); /* Crea un nuevo array copiando las tareas existentes y añadiendo la nueva al final */
                setTarea(""); /* Vacia el input al pulsar Enter volviendo a su estado inicial: "Añade una tarea y pulsa Enter" */
              }
            }}
          />
		...
		{/*Esto me crea un listado con cada nueva tarea al macenada*/}
            ...
            {nuevaTarea.map((item, index) => (
              ...
              >
                ...
                <span
                  ...
                  onClick={() => setNuevaTarea(nuevaTarea.filter((_, i) => i !== index))}
                >
                  <i class="borrar fa-regular fa-rectangle-xmark"></i> {/* Icono X */}
                </span>
              </li>
            ))}
          ...
          <div className="note-footer">
            {nuevaTarea.length} Tarea{nuevaTarea.length !== 1 && "s"} {/* Si la cantidad es diferente a 1 añade una "s" al final de la palabra tarea*/}
          </div>
        </div>
      </div>
    </div>
